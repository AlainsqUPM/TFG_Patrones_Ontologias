    ...
    try:
        ...
        for e in g:
            if len(e)==3:
                ...
                label3=str(e[2])
                if label1 in filtro:
                    etiquetas[label1][0]+=1; con+=1
                    if etiquetas[label1][0] == 1: relativo+=1
                if label2 in filtro:
                    etiquetas[label2][1]+=1; con+=1
                    if etiquetas[label2][1] == 1: relativo+=1
                if label3 in filtro:
                    etiquetas[label3][2]+=1; con+=1
                    if etiquetas[label3][2] == 1: relativo+=1          
